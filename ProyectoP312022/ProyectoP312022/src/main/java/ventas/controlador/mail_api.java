...
public class mail_api {
    ...
    public void SendMailAPI(String to, String subject, String msg, String Titulo_principal, String nombrec) {
...
"                <h1 style=\"text-shadow: 3px 5px 5px rgb(7, 6, 1); font-family: 'comic sans MS'; color: white; margin-bottom: 0; background-color: rgb(235, 78, 78); text-align: center; height: 50px; padding-top: 15px; margin-left: 20%; margin-right: 20%;\">"+Titulo_principal+"</h1>\n" +
"            </div>\n" +

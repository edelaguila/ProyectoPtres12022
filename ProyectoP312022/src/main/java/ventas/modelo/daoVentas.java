...
public class daoVentas {
    ...
    private static final String SQL_SELECT = "SELECT id_venta, tipo, cantidad, producto, precio, total, fecha, id_cliente, id_vendedor, tipo_de_pago FROM tbl_ventas";
    private static final String SQL_INSERT = "INSERT INTO tbl_ventas(tipo, cantidad, producto, precio, total, fecha, id_cliente, id_vendedor, tipo_de_pago) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)";
    private static final String SQL_UPDATE = "UPDATE tbl_ventas SET tipo=?, cantidad=?, producto=?, precio=?, total=?, fecha=?, id_cliente=?, id_vendedor=?  AND tipo_de_pago=? WHERE id_venta = ?";
    private static final String SQL_DELETE = "DELETE FROM tbl_ventas WHERE id_venta=?";
    private static final String SQL_QUERY = "SELECT id_venta, tipo, cantidad, producto, precio, total, fecha, id_cliente, id_vendedor, tipo_de_pago FROM tbl_ventas WHERE id_venta = ?";
    ...
    public List<clsVentas> select() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String Stipo_de_pago = rs.getString("tipo_de_pago");
                ...
                venta.fSettipo_Venta(Stipo_de_pago);
    ...
    public int insert(clsVentas venta) {
        ...
        try {
            ...
            stmt.setString(9, venta.fGetpago_Vendedor());

...
Document document = new Document();
  ...
  public void creacion(String datos[][], String fecha, String correo, String cliente){
 try{
            PdfWriter.getInstance(document, new FileOutputStream("Creacion_PDF.pdf"));
          ...
          Image header = Image.getInstance("C:\\Users\\Pablo\\Desktop\\descargas\\Material\\Captura.jpg");
            ...
            Image enca = Image.getInstance("C:\\Users\\Pablo\\Desktop\\descargas\\Material\\enca.jpg");
